...
/*
Вся магия обработки контроллера происходит, благодаря роутингу (маршрутам)
давайте рассмотрим, что же такое: ?r=site/hello2
site - это контроллер
hello2 - это действие в этом контроллере (т.е. site)
 * */

/*
 Контроллеры именуются с большой буквы т.е. Site а заканчиваться название должно
именно на солво Controller т.е. SiteController / UserController и.т.д.
У нутри должен распологаться класс, повторяющий имя файла, т.е.
class SiteController который ВСЕГДА должен наследоваться от - extends Controller
 * */